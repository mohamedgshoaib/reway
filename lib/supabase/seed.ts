...
export const DEMO_GROUPS: SeedGroup[] = [
  {
    ...
    bookmarks: [
      ...
      },
      {
        ...
        title: "Devloop",
        description: "Visit Devloop Software agency maintaining Reway.",
        favicon_url: "https://www.devloop.software/favicon.ico",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    bookmarks: [
      ...
      },
      {
        ...
        title: "Hero UI",
        description: "Beautiful, customizable UI components for modern apps.",
        favicon_url: "https://heroui.com/icons/favicon.svg",
      },
      {
        url: "https://coss.com/ui",
        title: "Coss UI",
        description: "UI resources and components from Coss.",
        favicon_url: "https://coss.com/favicon.ico",
      },
    ],
  },
];
