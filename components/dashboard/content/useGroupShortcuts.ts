...
import { normalizeAlphaNumericKey, shouldIgnoreDashboardHotkey } from "@/lib/keyboard"
import type { GroupRow } from "@/lib/supabase/queries"
import { ALL_BOOKMARKS_GROUP_ID, MOST_VISITED_GROUP_ID } from "@/lib/system-groups"
...
export function useGroupShortcuts({ groups, setActiveGroupId }: UseGroupShortcutsOptions) {
